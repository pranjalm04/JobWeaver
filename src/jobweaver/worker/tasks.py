...
from jobweaver.config import PipelineConfig
from jobweaver.storage.writer import append_jsonl
from jobweaver.pipeline.runner import PipelineRunner
from jobweaver.pipeline.stages.job_details_llm import extract_job_data
from jobweaver.pipeline.stages.job_links import scrape_jobs_to_dict
from jobweaver.pipeline.stages.listing_llm import JobListingSchema, analyze_full_html_with_llm
from jobweaver.worker.celery_app import celery_app
...
@celery_app.task(
    name="jobweaver.analyze_listing",
    bind=True,
    autoretry_for=(ConnectionError, OSError, TimeoutError),
    retry_backoff=True,
    retry_jitter=True,
...
@celery_app.task(name="jobweaver.scrape_job_links")
...
@celery_app.task(name="jobweaver.extract_job_details")
